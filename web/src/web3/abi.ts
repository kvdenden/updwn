...
export const gameEngineAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'updwn_', internalType: 'address', type: 'address' },
      { name: 'priceFeed_', internalType: 'address', type: 'address' },
      { name: 'treasury_', internalType: 'address', type: 'address' },
      { name: 'strategy_', internalType: 'address', type: 'address' },
      { name: 'broker_', internalType: 'address', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct GameEngine.Reward',
        type: 'tuple',
        components: [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'event_', internalType: 'bytes32', type: 'bytes32' },
  ...
  },
  {
    ...
    name: 'strategy',
    outputs: [
      { name: '', internalType: 'contract IRewardStrategy', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    name: 'updwn',
    outputs: [{ name: '', internalType: 'contract UPDWN', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'event',
